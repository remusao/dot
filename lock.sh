...
export PYTHON="3.10.5"
# export PYTHON="3.8.13"

# https://golang.org/dl/
export GO="1.18"

# https://github.com/koalaman/shellcheck/releases/latest
export SHELLCHECK="0.8.0"

# Glasgow Haskell Compiler
export HASKELL_GHC="9.2.2"
export HASKELL_LANGUAGE_SERVER="1.7.0.0"
