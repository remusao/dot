...
let g:ycm_language_server = [
  \   {
  \     'name': 'bash',
  \     'cmdline': [ 'node', '/home/remi/.nvm/versions/node/v22.15.0/bin/bash-language-server', 'start' ],
  \     'filetypes': [ 'sh', 'bash' ],
  \   },
  \   {
  \     'name': 'yaml',
  \     'cmdline': [ 'node', '/home/remi/.nvm/versions/node/v22.15.0/bin/yaml-language-server', '--stdio' ],
  \     'filetypes': [ 'yaml' ],
  \   },
  \   { 'name': 'docker',
  \     'filetypes': [ 'dockerfile' ],
  \     'cmdline': [ '/home/remi/.nvm/versions/node/v22.15.0/bin/docker-langserver', '--stdio' ]
  \   },
  \   {
  ...
  \   {
  \     'name': 'svelte',
  \     'cmdline': [ 'node', '/home/remi/.nvm/versions/node/v22.15.0/bin/svelteserver', '--stdio' ],
  \     'filetypes': [ 'svelte' ],
  \   },
  \ ]
" }}}
